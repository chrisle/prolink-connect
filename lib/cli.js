 ...
 */
exports.VIRTUAL_CDJ_NAME = 'Now Playing';
/**
...
async function viaRemote(remote, device, opts) {
    const { deviceId, trackSlot, trackType, track, span } = opts;
...
class MetadataORM {
    constructor() {
        ...
        __classPrivateFieldSet(this, _MetadataORM_conn, (0, better_sqlite3_multiple_ciphers_1.default)(':memory:'), "f");
...
var _PositionEmitter_beatSocket, _PositionEmitter_emitter, _PositionEmitter_handlePosition;
Object.defineProperty(exports, "__esModule", ({ value: true }));
const events_1 = __webpack_require__(/*! events */ "events");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/status/utils.ts");
/**
...
class PositionEmitter {
    ...
    constructor(beatSocket) {
        _PositionEmitter_beatSocket.set(this, void 0);
        /**
        ...
        __classPrivateFieldSet(this, _PositionEmitter_beatSocket, beatSocket, "f");
        beatSocket.on('message', __classPrivateFieldGet(this, _PositionEmitter_handlePosition, "f"));
    }
}
_PositionEmitter_beatSocket = new WeakMap(), _PositionEmitter_emitter = new WeakMap(), _PositionEmitter_handlePosition = new WeakMap();
 ...
 */
exports.Severity = Sentry.Severity;
